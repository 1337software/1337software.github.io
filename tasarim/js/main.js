...
$(document).ready(function() {
  	$("#.close").click(function showAlert() {
    	$(".alert-drop").fadeTo(2000, 500).slideUp(500, function() {
      		$(".alert-drop").slideUp(500);
    	});
  	});
});
...
class Particle {
  	constructor(canvas) {
	    ...
	    let colors = ["#2185d0","#2185d0","#2185d0", "#2185d0","#2185d0"]
    	...
    	if (i > 0 && (i % 3 == 0 || i % 7 == 0)) {
      		...
      		let box2 = element.getCoordinates();
		     	...
		     	canvas.lineWidth = 0.8;
		      	...
		      	//canvas.strokeStyle = "#111318";
		      	if (i % 7 == 0) {
		        	canvas.strokeStyle="#15181e";
		      	}
      		canvas.stroke();
      		canvas.closePath();
    	}
