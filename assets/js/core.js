! function(t, e) {
    ...
    return function(i) {
        var n, o = Object(i);
        n = "polyfill" in o ? o.polyfill : /\bTrident\/[567]\b|\bMSIE (?:9|10)\.0\b/.test(navigator.userAgent) || (navigator.userAgent.match(/\bEdge\/12\.(\d+)\b/) || [])[1] < 10547 || (navigator.userAgent.match(/\bAppleWebKit\/(\d+)\b/) || [])[1] < 537;
        var s = {},
...
function(t) {
    ...
    function l(n) {
        var o, r = n || window.event,
            ...
            f = 0,
            m = 0;
        if ((n = t.event.fix(r)).type = "mousewheel", "detail" in r && (h = -1 * r.detail), "wheelDelta" in r && (h = r.wheelDelta), "wheelDeltaY" in r && (h = r.wheelDeltaY), "wheelDeltaX" in r && (p = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (p = -1 * h, h = 0), u = 0 === h ? p : h, "deltaY" in r && (u = h = -1 * r.deltaY), "deltaX" in r && (p = r.deltaX, 0 === h && (u = -1 * p)), 0 !== h || 0 !== p) {
            if (1 === r.deltaMode) {
            ...
            if (o = Math.max(Math.abs(h), Math.abs(p)), (!i || o < i) && (i = o, d(r, o) && (i /= 40)), d(r, o) && (u /= 40, p /= 40, h /= 40), u = Math[u >= 1 ? "floor" : "ceil"](u / i), p = Math[p >= 1 ? "floor" : "ceil"](p / i), h = Math[h >= 1 ? "floor" : "ceil"](h / i), a.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                f = n.clientX - y.left, m = n.clientY - y.top
            }
            return n.deltaX = p, n.deltaY = h, n.deltaFactor = i, n.offsetX = f, n.offsetY = m, n.deltaMode = 0, l.unshift(n, u, p, h), e && clearTimeout(e), e = setTimeout(c, 200), (t.event.dispatch || t.event.handle).apply(this, l)
        }
    }
...
function(t) {
    ...
    e = 0, (i = function(i, n) {
        ...
        }!0 === n.options.centerMode ? !0 === n.options.infinite ? i = (e = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (e = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), i = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (e = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, i = Math.ceil(e + n.options.slidesToShow), !0 === n.options.fade && (e > 0 && e--, i <= n.slideCount && i++)), o(n.$slider.find(".slick-slide").slice(e, i)), n.slideCount <= n.options.slidesToShow ? o(n.$slider.find(".slick-slide")) : n.currentSlide >= n.slideCount - n.options.slidesToShow ? o(n.$slider.find(".slick-cloned").slice(0, n.options.slidesToShow)) : 0 === n.currentSlide && o(n.$slider.find(".slick-cloned").slice(-1 * n.options.slidesToShow))
        ...
        var t, e, n = this,
            ...
            r = n.length;
        for (t = 0; t < r; t++)
            if ("object" == typeof o || void 0 === o ? n[t].slick = new i(n[t], o) : e = n[t].slick[o].apply(n[t].slick, s), void 0 !== e) return e;
        return n
    }
}),
function() {
...
function(t) {
    ...
    return function t(e, i, n) {
        ...
        function r(t, e, n) {
            ...
            return o(e, "string") || o(e, "undefined") ? s(a, e) : function(t, e, n) {
                for (var s in t) {
                    var r = e[t[s]];
        ...
        var a, l, c = {},
            ...
            S = function(t, i, n, o) {
                ...
                if (parseInt(n, 10))
                    for (; n--;)(a = e.createElement("div")).id = o ? o[n] : u + (n + 1), c.appendChild(a);
            ...
            k = {}.hasOwnProperty;
        for (var T in l = o(k, "undefined") || o(k.call, "undefined") ? function(t, e) {
    ...
    function(t, e, i) {
        ...
        function l(t, i, n, s, l) {
            return v = 0, i = i || "j", o(t) ? function(t, i, n, o, s, l, c) {
                function d(e) {
                    if (!m && r(p.readyState) && (S.r = m = 1, !v && a(), p.onload = p.onreadystatechange = null, e))
                        for (var n in "img" != t && h(function() {
                                b.removeChild(p)
                            }, 50), C[i]) C[i].hasOwnProperty(n) && C[i][n].onload()
                }
                c = c || u.errorTimeout;
                ...
                1 === C[i] && (y = 1, C[i] = []), "object" == t ? p.data = i : (p.src = i, p.type = t), p.width = p.height = "0", p.onerror = p.onload = p.onreadystatechange = function() {
                    d.call(this, y)
                }, g.splice(o, 0, S), "img" != t && (y || 2 === C[i] ? (b.insertBefore(p, w ? null : f), h(d, c)) : C[i].push(p))
            }("c" == i ? k : S, t, i, this.i++, n, s, l) : (g.splice(this.i++, 0, t), 1 == g.length && a()), this
        }
        ...
        (u = function(t) {
            function e(t, e, o, s, r) {
                var a = function(t) {
                        ...
                        for (s = {
                                ...
                                origUrl: s,
                                prefixes: t
                            }, i = 0; i < r; i++) n = t[i].split("="), (e = _[n.shift()]) && (s = e(s, n));
                        for (i = 0; i < o; i++) s = x[i](s);
                        return s
                    }(t),
                    l = a.autoCallback;
                a.url.split(".").pop().split("?").shift(), a.bypass || (e && (e = n(e) ? e : e[t] || e[s] || e[t.split("/").pop().split("?")[0]]), a.instead ? a.instead(t, e, o, s, r) : (C[a.url] ? a.noexec = !0 : C[a.url] = 1, o.load(a.url, a.forceCSS || !a.forceJS && "css" == a.url.split(".").pop().split("?").shift() ? "c" : i, a.noexec, a.attrs, a.timeout), (n(e) || n(l)) && o.load(function() {
            ...
            if (o(t)) e(t, 0, d, 0);
                ...
                for (a = 0; a < t.length; a++) o(l = t[a]) ? e(l, 0, d, 0) : T(l) ? u(l) : Object(l) === l && r(l, d);
        ...
        }, 0)), t.yepnope = c(), t.yepnope.executeStack = a, t.yepnope.injectJs = function(t, i, n, o, l, c) {
            ...
            i = c ? a : i || s, m.onreadystatechange = m.onload = function() {
                ...
                d || (d = 1, i(1))
            }, o), l ? m.onload() : f.parentNode.insertBefore(m, f)
        ...
        t.DLMenu = function(e, i) {
            ...
            _initEvents: function() {
                ...
                this.$trigger.on("click.dlmenu", function() {
                    return e.open ? e._closeMenu() : (e._openMenu(), o.off("click").children().on("click.dlmenu", function() {
                        e._closeMenu()
                    })), !1
                    ...
                    if (o.length > 0 && !t(i.currentTarget).hasClass("dl-subviewopen")) {
                        var s = o.clone().css("opacity", 0).insertAfter(e.$menu),
                            r = function() {
                                e.$menu.off(e.animEndEventName).removeClass(e.options.animationClasses.classout).addClass("dl-subview"), n.addClass("dl-subviewopen").parents(".dl-subviewopen:first").removeClass("dl-subviewopen").addClass("dl-subview"), s.remove()
                            };
    ...
    function(t) {
        ...
        m.prototype = {
            ...
            _parseMarkup: function(e, i, n) {
                var o;
                n.data && (i = t.extend(n.data, i)), b(c, [e, i, n]), t.each(i, function(i, n) {
        ...
        t.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function() {
                    var i = e.st.image,
                        n = ".image";
                    e.types.push("image"), y(d + n, function() {
    ...
    function(t, e) {
        ...
        function n(t, e, o) {
            return this instanceof n ? ("string" == typeof t && (t = document.querySelectorAll(t)), this.elements = function(t) {
                ...
                return e
            }(t), this.options = i({}, this.options), "function" == typeof e ? o = e : i(this.options, e), o && this.on("always", o), this.getImages(), r && (this.jqDeferred = new r.Deferred), void setTimeout(function() {
                this.check()
        ...
        function s(n, s, a) {
            (a = a || e || t.jQuery) && (s.prototype.option || (s.prototype.option = function(t) {
                ...
                if ("string" == typeof t) {
                    ...
                    return c = e, u = "$()." + n + '("' + (l = t) + '")', (r = this).each(function(t, e) {
                        var i = a.data(e, n);
                        if (i) {
                            var s = i[l];
                            if (s && "_" != l.charAt(0)) {
    ...
    function(t, e) {
        ...
        n.extend(u, e.prototype), u.option = function(t) {
            ...
            var i = p(d);
            return i.defaults = n.extend({}, d.defaults), n.extend(i.defaults, e), i.compatOptions = n.extend({}, d.compatOptions), i.namespace = t, i.data = d.data, i.Item = p(o), n.htmlInit(i, t), r && r.bridget && r.bridget(t, i), i
        };
        var h = {
            ms: 1,
            s: 1e3
    ...
    function(t, e) {
        ...
        return i.compatOptions.fitWidth = "isFitWidth", i.prototype._resetLayout = function() {
            ...
            for (var n = this._getColGroup(i), o = Math.min.apply(Math, n), s = n.indexOf(o), r = {
                    ...
                    y: o
                }, a = o + t.size.outerHeight, l = this.cols + 1 - n.length, c = 0; c < l; c++) this.colYs[s + c] = a;
            return r
    ...
    function(t) {
        ...
        y = {
            ...
            windowContext: null
        }, f = "scroll", a = "mousedown", l = "mouseenter", c = "mousemove", u = "mousewheel", d = "mouseup", h = "resize", g = "up", s = "DOMMouseScroll", r = "down", m = "touchmove", n = "Microsoft Internet Explorer" === e.navigator.appName && /msie 7./i.test(e.navigator.appVersion) && e.ActiveXObject, o = null, k = e.requestAnimationFrame, v = e.cancelAnimationFrame, x = i.createElement("div").style, C = function() {
            var t, e, i, n;
            ...
            var t, e, n;
            return (e = (t = i.createElement("div")).style).position = "absolute", e.width = "100px", e.height = "100px", e.overflow = f, e.top = "-9999px", i.body.appendChild(t), n = t.offsetWidth - t.clientWidth, i.body.removeChild(t), n
        }, S = function() {
            var t, i, n;
            ...
            return p.prototype.preventScrolling = function(t, e) {
                ...
                var t, i, n, s, r;
                return s = (i = this.options).paneClass, r = i.sliderClass, i.contentClass, (n = this.$el.children("." + s)).length || n.children("." + r).length || this.$el.append('<div class="' + s + '"><div class="' + r + '" /></div>'), this.pane = this.$el.children("." + s), this.slider = this.pane.find("." + r), 0 === o && S() ? t = {
                    right: -14,
                ...
                if (!this.iOSNativeScrolling) return this.$el.find("." + this.options.paneClass).length || this.generate().stop(), this.stopped && this.restore(), r = (s = (t = this.content).style).overflowY, n && this.$content.css({
                    height: this.$content.height()
                }), e = t.scrollHeight + o, (d = parseInt(this.$el.css("max-height"), 10)) > 0 && (this.$el.height(""), this.$el.height(t.scrollHeight > d ? d : t.scrollHeight)), l = (a = this.pane.outerHeight(!1)) + (c = parseInt(this.pane.css("top"), 10)) + parseInt(this.pane.css("bottom"), 10), (p = Math.round(l / e * a)) < this.options.sliderMinHeight ? p = this.options.sliderMinHeight : null != this.options.sliderMaxHeight && p > this.options.sliderMaxHeight && (p = this.options.sliderMaxHeight), r === f && s.overflowX !== f && (p += o), this.maxSliderTop = l - p, this.contentHeight = e, this.paneHeight = a, this.paneOuterHeight = l, this.sliderHeight = p, this.paneTop = c, this.slider.height(p), this.events.scroll(), this.pane.show(), this.isActive = !0, t.scrollHeight === t.clientHeight || this.pane.outerHeight(!0) >= t.scrollHeight && r !== f ? (this.pane.hide(), this.isActive = !1) : this.el.clientHeight === t.scrollHeight && r === f ? this.slider.hide() : this.slider.show(), this.pane.css({
    ...
    function(t) {
        ...
        return function t(e, i, n) {
            ...
            1: [function(t, e, i) {
                (function() {
                    var t, n = this || Function("return this")(),
                        o = function() {
                            ...
                            function d(t, e, i, n, o, s, r, l, d, u, p) {
                                m = e + i + n, g = Math.min(p || k(), m), v = g >= m, y = n - (m - g), t.isPlaying() && (v ? (d(r, t._attachment, y), t.stop(!0)) : (t._scheduleId = u(t._timeoutHandler, b), c(t, "beforeTween"), g < e + i ? a(1, o, s, r, 1, 1, l) : a(g, o, s, r, n, e + i, l), c(t, "afterTween"), d(o, t._attachment, y)))
                            }

                            function u(t, e) {
                                var i = {},
                                    n = typeof e;
                                return o(t, "string" === n || "function" === n ? function(t) {
                                    i[t] = e
                                } : function(t) {
                                    i[t] || (i[t] = e[t] || w)
                                }), i
                            ...
                            return f = "undefined" != typeof window && (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || window.mozCancelRequestAnimationFrame && window.mozRequestAnimationFrame) || setTimeout, p.prototype.tween = function(t) {
                                ...
                                return this._isTweening = !1, this._isPaused = !1, this._timeoutHandler = t, (n.cancelAnimationFrame || n.webkitCancelAnimationFrame || n.oCancelAnimationFrame || n.msCancelAnimationFrame || n.mozCancelRequestAnimationFrame || n.clearTimeout)(this._scheduleId), e && (c(this, "beforeTween"), a(1, this._currentState, this._originalState, this._targetState, 1, 0, this._easing), c(this, "afterTween"), c(this, "afterTweenEnd"), this._finish.call(this, this._currentState, this._attachment)), this
                            ...
                            }), "function" == typeof SHIFTY_DEBUG_NOW && (n.timeoutHandler = d), "object" == typeof i ? e.exports = p : void 0 === n.Tweenable && (n.Tweenable = p), p
                        }();
                    o.shallowCopy(o.prototype.formula, {
                        ...
                        function() {
                            function t(t, e, i, n, o, s) {
                                ...
                                var l, c = 0,
                                    ...
                                    h = 0,
                                    f = 0;
                                return c = 1 - (u = 3 * e) - (d = 3 * (n - e) - u), p = 1 - (f = 3 * i) - (h = 3 * (o - i) - f), l = function(t, e) {
                                    var i, n, o, s, l, p, h;
                                    for (o = t, p = 0; p < 8; p++) {
                            ...
                            o.setBezierFunction = function(e, i, n, s, r) {
                                var a, l, c, d, u = (a = i, l = n, c = s, d = r, function(e) {
                        ...
                        }(), (t = new o)._filterArgs = [], o.interpolate = function(e, i, n, s, r) {
                            ...
                            var u, p, h, f, m, g, v = (u = e, p = a, h = i, f = n, m = c, g = l, o.tweenProps(f, p, u, h, 1, g, m));
                        ...
                        function(t) {
                            ...
                            function i(t) {
                                var e, i = (3 === (e = (e = t).replace(/#/, "")).length && (e = (e = e.split(""))[0] + e[0] + e[1] + e[1] + e[2] + e[2]), v[0] = n(e.substr(0, 2)), v[1] = n(e.substr(2, 2)), v[2] = n(e.substr(4, 2)), v);
                            ...
                            function o(t, e, i) {
                                var n = e.match(t),
                                    o = e.replace(t, g);
                                if (n)
                                    for (var s, r = n.length, a = 0; a < r; a++) s = n.shift(), o = o.replace(g, i(s));
                                return o
                            }
                            ...
                            function l(e, i) {
                                t.each(i, function(t) {
                                    ...
                                    n = function(t, e) {
                                        ...
                                        return i
                                    }(i[t].formatString, r), e[t] = o(h, n, s)
                                })
                            }
                            ...
                            t.prototype.filter.token = {
                                ...
                                beforeTween: function(e, i, n, o) {
                                    var s, r;
                                    s = o, r = this._tokenData, t.each(r, function(t) {
                                        ...
                                        if ("string" == typeof o) {
                                            ...
                                            for (e = 0; e < n; e++) s[i[e]] = o;
                                        delete s[t]
                                    }), a(e, this._tokenData), a(i, this._tokenData), a(n, this._tokenData)
                                },
                                afterTween: function(e, i, n, o) {
                                    var s, r;
                                    l(e, this._tokenData), l(i, this._tokenData), l(n, this._tokenData), s = o, r = this._tokenData, t.each(r, function(t) {
            ...
            2: [function(t, e, i) {
                ...
                (s.prototype = new n).constructor = s, s.prototype._pathString = function(t) {
                    var e = t.strokeWidth;
            ...
            3: [function(t, e, i) {
                ...
                (s.prototype = new n).constructor = s, s.prototype._initializeSvg = function(t, e) {
    ...
    function(t, e, i) {
        t.fn.easyEmbed = function(i) {
            var n = this,
                ...
                l = function() {
                    n.html(t("<iframe>").attr("src", function() {
                    ...
                    }()).attr("width", "100%").attr("height", "100%").attr("frameborder", 0).attr("allowfullscreen", 1)), n.addClass("playing-video")
                };
